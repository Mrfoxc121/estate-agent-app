  ...
  return (
    <li className="relative bg-white flex flex-col justify-between items-center shadow-md hover:shadow-xl rounded-md overflow-hidden transition-shadow duration-150 mb-4">
      <Link to={`/category/${listing.type}/${id}`} className="contents">
        <img src={listing.imgUrls[0]} alt="" className="h-[170px] w-full object-cover hover:scale-105 duration-200 ease-in" loading="lazy" />
        ...
        <div className="w-full p-[10px]">
          <div className="flex items-center space-x-1">
            ...
            <p className="font-semibold m-0 text-sm mb-[2px] text-gray-600 truncate">{listing.address}</p>
          </div>
